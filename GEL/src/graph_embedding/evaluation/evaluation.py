...
from graph_embedding.eval_metrics.metrics import *
...
def LinkPrediction(embedding_look_up, original_graph, train_graph, test_pos_edges, seed):
    ...
    MAP = calculateMAP(text_edges, y_test, y_pred, original_graph, 10)
    MRR = computeMRR(text_edges, y_test, y_pred, original_graph, 10)
